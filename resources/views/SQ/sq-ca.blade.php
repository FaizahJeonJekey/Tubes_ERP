...
<div class="container-fluid mt-4">
    ...
    <form action="{{ url('/SQ/data/list/ca/'.$sq->id)}}" method="post" class="" name="input-form" id="input-form">
        {{ csrf_field() }}
    ...
    <form action="{{ url('/SQ/data/list/bp/'.$sq->id)}}" method="post" class="" name="input-form" id="input-form">
        {{ csrf_field() }}  
